...
1. **Copy templates to this directory:**
   ```bash
   cp claude_src/novel/templates/epub/metadata.yaml draft/compiled/
   cp claude_src/novel/templates/epub/epub.css draft/compiled/
   ```
...
*See claude_src/novel/skills/epub-generator.md for technical details*
